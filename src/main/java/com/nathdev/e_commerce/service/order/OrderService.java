...
import com.nathdev.e_commerce.model.OrderItem;
import com.nathdev.e_commerce.model.Product;
import com.nathdev.e_commerce.repository.OrderRepository;
import com.nathdev.e_commerce.repository.ProductRepository;
import com.nathdev.e_commerce.service.cart.CartService;
...
public class OrderService implements IOrderService{
   ...
   private Order createOrder(Cart cart){
    ...
    private List<OrderItem> createOrderItems(Order order , Cart cart){
        return cart.getItems().stream().map(cartItem -> { Product product = cartItem.getProduct(); product.setInventory(product.getInventory() - cartItem.getQuantity());
